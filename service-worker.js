const CACHE='italia-2026-v3';
const CORE=['./','./index.html','./styles.css','./script.js','./enhancements.css','./enhancements.js','./booking-reminders.ics','./manifest.webmanifest','./icon.svg'];
